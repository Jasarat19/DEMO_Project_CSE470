        ...
        <div class="row">
            <div class="col-sm-9">
                ...
                <div class="row border-top py-3 mt-3">
                    <div class="col-sm-2">
                        <img src="<?php echo $item['item_image'] ?? "./assets/products/women-diamond-heart-ring-3.jpg" ?>" style="height: 120px;" alt="cart1" class="img-fluid">
                    </div>
                    <div class="col-sm-8">
            ...
            <div class="col-sm-3">
                <div class="sub-total border text-center mt-2">
                    ...
                    <div class="border-top py-4">
                        ...
                        <a href="payment.php" type="button" class="btn btn-warning mt-3">Proceed to Buy</a>
