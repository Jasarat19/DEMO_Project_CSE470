            ...
            <div class="owl-carousel owl-theme">
                <div class="item wow bounceInUp">
                    <div class="card border-0 font-rale mr-5" style="width: 18rem;">
                        <h5 class="card-title font-size-16"> Special Jewellary </h5>
                ...
                <div class="item wow bounceInUp">
                    <div class="card border-0 font-rale mr-5" style="width: 18rem;">
                        <h5 class="card-title font-size-16"> New Jewellary </h5>
                ...
                <div class="item wow bounceInUp">
                    <div class="card border-0 font-rale mr-5" style="width: 18rem;">
                        <h5 class="card-title font-size-16"> Upcomimg Jewellary </h5>
