...
?>
 <section id="product" class="py-3">
            <div class="container">
                <div class="row">
                    <div class="col-sm-6">
                        <img src="<?php echo $item['item_image'] ?? "./assets/products/women-diamond-heart-ring-3.jpg" ?>" alt="product" class="img-fluid">
                    ...
                    <div class="col-sm-6 py-5">
                        ...
                        <!---    product price       -->
                            <table class="my-3">
                                ...
                                <tr class="font-rale font-size-14">
                                    <td>You Save:</td>
                                    <td><span class="font-size-16 text-danger">$52.00</span></td>
                                </tr>
                            </table>
                        <!---    !product price       -->
                            ...
                            <div id="policy">
                                <div class="d-flex">
                                    ...
                                    <div class="return text-center mr-5">
                                        ...
                                        <a href="#" class="font-rale font-size-12">JasShopie <br>Deliverd</a>
                                    </div>
                                    <div class="return text-center mr-5">
                                        <div class="font-size-20 my-2 color-second">
                        ...
                        <!-- order-details -->
                            <div id="order-details" class="font-rale d-flex flex-column text-dark">
                                <small>Delivery by : Dec 3 - Dec 20</small>
                                <small>Sold by <a href="#">JasShopie </a>(4.5 out of 5 | 18,198 ratings)</small>
